  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--background)] text-[var(--foreground)] font-[var(--font-geist-sans,sans-serif)]">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-24 text-center">
        <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-4 max-w-2xl">
          A runtime frontend for any{" "}
          <span className="text-[var(--primary)]">OpenAPI described API.</span>
        </h1>
