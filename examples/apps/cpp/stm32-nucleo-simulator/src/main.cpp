...
int main(int argc, char* argv[]) {
  ...
  stm32::BoardSimulator simulator;
  ...
  stm32::register_static_routes(server, web_root);
  stm32::register_api_routes(server, simulator, openapi_path);
  ...
  std::cout << "STM32 Nucleo simulator listening on http://" << url_host << ":" << port << std::endl;
